...
export const EN: Partial<Record<keyof ViDictionary, string>> = {
  ...
  "kudos.dialog.image_remove": "Remove image",
  "kudos.dialog.image_invalid_type": "Only JPG or PNG images are allowed.",
  "kudos.dialog.image_too_large": "Image exceeds 5MB.",
  "kudos.dialog.image_upload_failed": "Could not upload the image. Please try again.",
  "kudos.dialog.anonymous": "Send thanks and recognition anonymously",
  "kudos.dialog.anonymous_name_placeholder": "Anonymous name",
  "kudos.dialog.error_recipient_required": "Please pick a recipient.",
  "kudos.dialog.error_hashtag_required": "Cannot be empty.",
  "kudos.dialog.error_content_required": "Cannot be empty.",
  ...
  "sun_kudos.filter_hashtag_label": "Filter by hashtag",
  "sun_kudos.filter_hashtag_open": "Open hashtag filter",
  "sun_kudos.filter_hashtag_max": "Max {n}",
